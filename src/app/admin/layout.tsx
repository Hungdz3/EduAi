  ...
  return (
    <div className="flex h-screen bg-slate-900 text-slate-100">
      <aside className="w-64 bg-slate-950 border-r border-slate-800 p-4 flex flex-col">
        <div className="text-xl font-bold text-white mb-8 flex items-center border-b border-slate-800 pb-4">
        ...
        <nav className="flex-1 space-y-2 text-sm">
          ...
          <Link href="/admin/ai-config" className="flex items-center p-3 rounded-lg hover:bg-slate-800 text-slate-300 hover:text-white transition-colors">
