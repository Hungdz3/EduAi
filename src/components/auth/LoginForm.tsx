        ...
        <form onSubmit={handleLogin} className="space-y-5">
          ...
          <div className="relative my-6">
            ...
            <div className="relative flex justify-center text-sm">
              <span className="px-3 text-slate-500 bg-slate-950/50 backdrop-blur-sm rounded-full">hoặc</span>
            </div>
          </div>
          
          <Button type="button" onClick={handleGoogleLogin} variant="outline" className="w-full h-11 bg-slate-900 border-white/10 text-white hover:bg-slate-800 hover:text-white transition-all shadow-sm">
